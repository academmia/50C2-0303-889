                        ...
                        <div className="row row align-items-center">
                            ...
                            <div className="col col-lg order-lg-first">
                                <ul className="nav nav-tabs border-0 flex-column flex-lg-row">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/task-voting" activeClassName="active" className="nav-link">
                                            <i className="fe fe-image"></i> 
                                            <FormattedMessage id="nav.taskvoting"
                                                defaultMessage="Task Voting"
                                                description="Task voting page link"/>    
                                        </NavLink>
                                    </li>
